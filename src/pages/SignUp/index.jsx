  ...
  return (
    <div className="h-full flex justify-center items-center bg-[#121212] p-3">
      <div className='bg-[#EAEAEC] w-[600px] flex items-center justify-center flex-col'>
        ...
        <form onClick={handleSubmit} className='mt-6 w-4/5 flex flex-col'>
          <h1 className='text-center mb-4 text-[#181c2e] font-bold text-2xl'>Nova conta</h1>
          <input
        ...
        to='/'>Já possui uma conta? Faça login</Link>
